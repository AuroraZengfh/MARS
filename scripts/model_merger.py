...
# parser.add_argument("--target_dir", required=False, default=None, type=str, help="The path for the target model")
...
def convert_fsdp_checkpoints_to_hfmodels():
    ...
    for key in keys:
        if args.tie_word_embedding and key == 'lm_head.weight':
            print("skip lm_head loading because of tie_word_embeddings")
            continue
        state_dict[key] = []
